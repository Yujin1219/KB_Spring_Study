...
// @Controller : 컨트롤러임을 알리는 어노테이션, Servlet Class를 대체하고, Bean으로 관리되는 대상
@Controller
...
//	}
	...
	// 메소드 이름으로 유사한 jsp로 매핑시켜주는 방법
	@RequestMapping("home2.do") // 핸들러 메소드로 맵핑하는 방법
	public void home2(){}

	// Redirect로 home3.do -> home2.do로 연결하는 방법
	@RequestMapping("home3.do") // 핸들러 메소드로 맵핑하는 방법
	public String home3(){
